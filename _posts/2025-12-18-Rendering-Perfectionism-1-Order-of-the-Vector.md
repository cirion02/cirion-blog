...
![Pixelated version vs Vector version]({{site.baseurl}}/assets/img/Order of the Widget.png)
...
![Colored Vector version]({{site.baseurl}}/assets/img/Order of the Widget Colored.png)
...
Also, if you want to download the SVG so you can use this yourself, here is the link:
[Order of the Widget Vector]({{site.baseurl}}/assets/other/Order of the Widget.svg)
