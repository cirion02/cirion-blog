...
Ok let's start by considering the level 1 optimal strategy. Kill the opponent at instant speed on turn 1. This is easiest to do by simply dealing 5 damage to them, for example using Breath of Malfegor. (Full list I've found [here](https://moxfield.com/decks/ZvHRLGy5sEiePgKHCwh5MQ), note, these are only the unconditional ones.[^1])
![Breath of Malfegor](https://cards.scryfall.io/large/front/7/a/7a12e4d0-8471-46ac-85e4-a2ea5be8bf8f.jpg?1562642287)
...
![Smirking Spelljacker](https://cards.scryfall.io/large/front/0/1/01d1e394-1b0c-4b40-ba85-f55973703d41.jpg?1712353792)
It gets around "can't be countered" and presents a threat that can win on its own if not stopped. So the level 3 question becomes, how do I beat counterspells? Well, just win without casting a spell. The main ways to do this are manlands and other lands that slowly win the game. (Full list I've found [here](https://moxfield.com/decks/kmQkO33X5UKKUg1egkasVw))
...
[^1]: For example, [Mindswipe](https://scryfall.com/card/ktk/189/mindswipe) requires there to be a spell on the stack to work.